/* ============================================
   PROFILE.JS - SIMPLIFIED WORKING VERSION
   ============================================ */
...
// ============================================
// UPLOAD PHOTO - USING CSS CLASS FOR LOADING
// ============================================
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    // USE CSS CLASS INSTEAD OF CHANGING TEXT
    uploadPhotoBtn.classList.add('btn-loading');
    ...
    reader.onload = async function(event) {
      ...
      try {
        ...
        uploadPhotoBtn.classList.remove('btn-loading');
...
// ============================================
// SAVE ACCOUNT - USING CSS CLASS FOR LOADING
// ============================================
if (saveAccountBtn) {
  saveAccountBtn.addEventListener("click", async function() {
    ...
    // CHANGE BUTTON TEXT - THIS WORKS BECAUSE IT'S IN THE CLICK EVENT
    this.disabled = true;
