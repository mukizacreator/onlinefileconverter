...
if (saveAccountBtn) {
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // SAVE ACCOUNT - Verification modal with custom message
...
if (changePasswordBtn) {
  changePasswordBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // CHANGE PASSWORD - Verification modal with custom message
      const code = await showModal({
        title: '🔐 Verification Code',
        message: 'Enter the 6-digit code sent to your email.\n\nAlso check your SPAM/JUNK folder.',
        input: true,
...
if (deleteAccountBtn) {
  deleteAccountBtn.addEventListener("click", async function(e) {
    ...
    try {
      ...
      // DELETE ACCOUNT - Verification modal with custom message
      const code = await showModal({
        title: '🔐 Verification Code',
        message: 'Enter the 6-digit code sent to your email.\n\nAlso check your SPAM/JUNK folder.',
        input: true,
