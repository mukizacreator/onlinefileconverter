/* ============================================
   PROFILE.JS - FIXED BUTTON TEXT CHANGES
   ============================================ */
window.onload = function() {
  ...
  /* ============================================
     PROFILE PHOTO UPLOAD - FIXED (Like Change Password)
     ============================================ */
  if (uploadPhotoBtn && profilePhotoInput) {
    ...
    profilePhotoInput.addEventListener("change", function(e) {
      ...
      // === FIX: Change button text using this (like Change Password) ===
  ...
  /* ============================================
     SAVE ACCOUNT - FIXED (Like Change Password)
     ============================================ */
  if (saveAccountBtn) {
