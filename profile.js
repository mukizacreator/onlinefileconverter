/* ============================================
   PROFILE.JS - FINAL VERSION (Copies Change Password pattern)
   ============================================ */
...
/* ============================================
   UPLOAD PHOTO - EXACT PATTERN AS CHANGE PASSWORD
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo (exact Change Password pattern)");
  
  // Click handler - opens file dialog
  ...
  // File change handler - EXACT PATTERN AS CHANGE PASSWORD
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    // ============================================
    // EXACT PATTERN AS CHANGE PASSWORD BUTTON
    // ============================================
    try {
      // THIS IS WHAT WORKS - same as Change Password
...
/* ============================================
   SAVE ACCOUNT - EXACT PATTERN AS CHANGE PASSWORD
   ============================================ */
if (saveAccountBtn) {
  console.log("✅ Setting up Save Account (exact Change Password pattern)");
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // REFRESH PAGE - Same as Change Password doesn't do this, but we need it
      setTimeout(function() {
