...
/* ============================================
   LOAD USER DATA FROM MONGODB - FORCE UI UPDATE
   ============================================ */
...
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", function(e) {
    ...
    modalContent.innerHTML = `
      <h3 style="color:white; margin-top:0;">📸 Uploading Photo</h3>
      <div style="width:100%; background:#333; border-radius:10px; overflow:hidden; height:25px; margin:20px 0;">
        <div id="progressBarFill" style="width:0%; height:100%; background:#00bcd4; transition: width 0.3s; border-radius:10px;"></div>
      </div>
      <p id="progressText" style="color:#aaa; margin:0;">0%</p>
    `;
...
if (saveAccountBtn) {
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      ...
      // Force reload user data to update ALL displays
      await loadUserData();
      
      // Force update the profile view with new data
      ...
      // Force profile view to be visible
      if (profileView) {
