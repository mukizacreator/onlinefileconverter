...
/* ============================================
   UPLOAD PHOTO BUTTON - EXACT SAME PATTERN AS CHANGE PASSWORD
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  console.log("✅ Setting up Upload Photo button");
  
  // Click handler - opens file dialog (like Change Password doesn't need this part)
  ...
  // File change handler - EXACT SAME PATTERN AS CHANGE PASSWORD
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    // ============================================
    // EXACT SAME PATTERN AS CHANGE PASSWORD BUTTON
    // ============================================
    const button = uploadPhotoBtn;
    const originalText = button.innerHTML;
    
    try {
      // CHANGE BUTTON TEXT - Same as Change Password uses this.disabled and this.textContent
      ...
      // RESTORE BUTTON - Same as Change Password
      ...
      // RESTORE BUTTON ON ERROR - Same as Change Password
      button.disabled = false;
      button.innerHTML = originalText;
...
/* ============================================
   SAVE ACCOUNT BUTTON - EXACT SAME PATTERN AS CHANGE PASSWORD
   ============================================ */
if (saveAccountBtn) {
  ...
  saveAccountBtn.addEventListener("click", async function() {
    ...
    try {
      // CHANGE BUTTON TEXT - Same as Change Password
      button.disabled = true;
...
/* ============================================
   CHANGE PASSWORD - MONGODB (WORKING - UNCHANGED)
   ============================================ */
