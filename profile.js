...
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  profilePhotoInput.addEventListener("change", async function(e) {
    ...
    // Using "this" directly like Change Password does
    // ============================================
    try {
      // THIS IS WHAT WORKS - using "this" directly (same as Change Password)
      this.disabled = true;
...
if (changePasswordBtn) {
  changePasswordBtn.addEventListener("click", async function() {
    ...
    try {
      // THIS IS WHAT WORKS - using "this" directly
      this.disabled = true;
      this.textContent = "Sending code...";
