...
/* ============================================
   TAB SWITCHING - WITH DEBUG
   ============================================ */
console.log("Setting up profile tabs...");

// Get tab elements with null checks
const overviewTab = document.getElementById("overviewTab");
const accountTab = document.getElementById("accountTab");
const securityTab = document.getElementById("securityTab");

console.log("Overview tab exists:", !!overviewTab);
console.log("Account tab exists:", !!accountTab);
console.log("Security tab exists:", !!securityTab);

function switchTab(activeTabId, panelId) {
  console.log(`Switching to tab: ${activeTabId}, panel: ${panelId}`);
...
if (accountTab) {
  ...
  console.error("Account tab element not found!");
}
