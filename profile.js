...
/* ============================================
   PHOTO UPLOAD HANDLER - Called from HTML onclick
   ============================================ */
async function handlePhotoUpload(event) {
  ...
  reader.onload = async function(readerEvent) {
    const photoData = readerEvent.target.result;
    try {
...
/* ============================================
   SAVE ACCOUNT HANDLER - Called from HTML onclick
   ============================================ */
async function handleSaveAccount(event) {
  ...
  // Change button text to "Sending code..."
  saveAccountBtn.disabled = true;
  saveAccountBtn.textContent = "Sending code...";
