/* ============================================
   PROFILE.JS - WORKING WITH BUTTON TEXT CHANGES
   ============================================ */
...
/* ============================================
   UPLOAD PHOTO BUTTON - CHANGES TO "Uploading..."
   ============================================ */
if (uploadPhotoBtn && profilePhotoInput) {
  ...
  uploadPhotoBtn.addEventListener("click", function(e) {
    ...
    // Change button text to "Uploading..." with faster spinner
    this.innerHTML = '<i class="fa-solid fa-spinner fa-spin" style="animation-duration: 0.5s;"></i> Uploading...';
    this.disabled = true;
...
/* ============================================
   SAVE ACCOUNT BUTTON - CHANGES TO "Sending code..."
   ============================================ */
if (saveAccountBtn) {
