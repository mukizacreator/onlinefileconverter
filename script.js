...
if (data.url) result.innerHTML = `<p>✅ Success!</p><a href="${data.url}" class="download-btn">Download</a>`;

else result.textContent = "❌ Conversion failed.";

} catch (err) { clearInterval(timer); result.textContent = "❌ Server error."; }
