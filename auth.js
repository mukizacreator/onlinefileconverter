...
if (signupForm) {
  signupForm.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      const code = await showVerificationModal('Enter the verification code sent to your email and Remember to check your SPAM/JUNK folder:');
      if (!code) {
