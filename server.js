...
/* ============================================
   ...
   ============================================ */
// Configure Brevo API - Correct syntax
...
app.post("/api/send-code", async (req, res) => {
  try {
    ...
    // Send email via Brevo - Correct syntax
    ...
    console.log(`✅ Verification email sent to ${email} via Brevo (Message ID: ${response.messageId})`);
