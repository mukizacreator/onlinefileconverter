...
// Main modal function - creates a custom modal with modern design
function showModal(options) {
    ...
    // Create overlay (dark background with blur effect)
    ...
    // Create modal box (glass-morphism design)
    ...
    let inputEl = null;
    if (input) {
        // Create wrapper for input and optional toggle button
...
// Verification modal - prompts user to enter 6-digit code
...
// Confirmation modal - asks user to confirm an action (e.g., delete, logout)
...
// Alert modal - shows a simple message with OK button
